function varargout = n132(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @n132_OpeningFcn, ...
                   'gui_OutputFcn',  @n132_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before n132 is made visible.
function n132_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for n132
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes n132 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = n132_OutputFcn(hObject, eventdata, handles)
