function varargout = n130(varargin)

gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @n130_OpeningFcn, ...
                   'gui_OutputFcn',  @n130_OutputFcn, ...
                   'gui_LayoutFcn',  [], ...
                   'gui_Callback',   []);
...
% --- Executes just before n130 is made visible.
function n130_OpeningFcn(hObject, eventdata, handles, varargin)
...
% Choose default command line output for n130
handles.output = hObject;

% Update handles structure
guidata(hObject, handles);

% UIWAIT makes n130 wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = n130_OutputFcn(hObject, eventdata, handles)
